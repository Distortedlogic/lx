...
- Implementation: [impl-lexer.md](../design/impl-lexer.md) (shell mode lexing), [impl-interpreter.md](../design/impl-interpreter.md) (shell execution)
- Design decisions: [design.md](design.md) ($ for shell)
- Test suite: [10_shell.lx](../tests/10_shell.lx)

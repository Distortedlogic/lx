...
- Implementation: [impl-parser.md](../design/impl-parser.md) (pattern parsing), [impl-checker.md](../design/impl-checker.md) (exhaustiveness checking), [impl-interpreter.md](../design/impl-interpreter.md) (pattern evaluation)
- Test suite: [07_patterns.lx](../tests/07_patterns.lx)

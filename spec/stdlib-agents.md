...
- Agent streaming (`~>>?`): [agents-streaming.md](agents-streaming.md)
- Agent pipelines with backpressure: [agents-pipeline.md](agents-pipeline.md)
- Shared knowledge: [stdlib-knowledge.md](stdlib-knowledge.md)
- Agent introspection: [stdlib-introspect.md](stdlib-introspect.md)
- Git integration: [stdlib-git.md](stdlib-git.md)
- Transient failure retry: [stdlib-retry.md](stdlib-retry.md)
- Agent-to-user interaction: [stdlib-user.md](stdlib-user.md)

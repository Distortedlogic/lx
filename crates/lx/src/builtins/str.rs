...
fn bi_trim(args: &[Value], span: Span) -> Result<Value, LxError> {
  match &args[0] {
...
fn bi_trim_start(args: &[Value], span: Span) -> Result<Value, LxError> {
  match &args[0] {
...
fn bi_trim_end(args: &[Value], span: Span) -> Result<Value, LxError> {
  match &args[0] {
...
fn bi_upper(args: &[Value], span: Span) -> Result<Value, LxError> {
  match &args[0] {
...
fn bi_lower(args: &[Value], span: Span) -> Result<Value, LxError> {
  match &args[0] {
...
fn bi_lines(args: &[Value], span: Span) -> Result<Value, LxError> {
  match &args[0] {
    Value::Str(s) => {
...
fn bi_chars(args: &[Value], span: Span) -> Result<Value, LxError> {
  match &args[0] {
    Value::Str(s) => {
...
fn bi_byte_len(args: &[Value], span: Span) -> Result<Value, LxError> {
  match &args[0] {
...
fn bi_join(args: &[Value], span: Span) -> Result<Value, LxError> {
...
fn bi_repeat(args: &[Value], span: Span) -> Result<Value, LxError> {
...
fn bi_starts(args: &[Value], span: Span) -> Result<Value, LxError> {
...
fn bi_ends(args: &[Value], span: Span) -> Result<Value, LxError> {
...
fn bi_pad_left(args: &[Value], span: Span) -> Result<Value, LxError> {
  let width = args[0]
    .as_int()
...
fn bi_pad_right(args: &[Value], span: Span) -> Result<Value, LxError> {
  let width = args[0]
    .as_int()

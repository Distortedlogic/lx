...
pub(super) fn bi_source_dir(_args: &[LxVal], _span: SourceSpan, ctx: &Arc<RuntimeCtx>) -> Result<LxVal, LxError> {
...
pub(super) fn bi_agent_implements(args: &[LxVal], _span: SourceSpan, _ctx: &Arc<RuntimeCtx>) -> Result<LxVal, LxError> {
...
pub(super) fn bi_json_parse(args: &[LxVal], span: SourceSpan, _ctx: &Arc<RuntimeCtx>) -> Result<LxVal, LxError> {
...
pub(super) fn bi_json_encode(args: &[LxVal], span: SourceSpan, _ctx: &Arc<RuntimeCtx>) -> Result<LxVal, LxError> {
  let s = serde_json::to_string(&args[0]).map_err(|e| LxError::runtime(e.to_string(), span))?;
  Ok(LxVal::str(s))
}

pub(super) fn bi_json_encode_pretty(args: &[LxVal], span: SourceSpan, _ctx: &Arc<RuntimeCtx>) -> Result<LxVal, LxError> {
  let s = serde_json::to_string_pretty(&args[0]).map_err(|e| LxError::runtime(e.to_string(), span))?;
  Ok(LxVal::str(s))
}

pub(super) fn bi_method_of(args: &[LxVal], _span: SourceSpan, _ctx: &Arc<RuntimeCtx>) -> Result<LxVal, LxError> {
...
pub(super) fn bi_global_context_current(_args: &[LxVal], _span: SourceSpan, _ctx: &Arc<RuntimeCtx>) -> Result<LxVal, LxError> {
  global_context_current()
}

pub(super) fn bi_global_context_get(args: &[LxVal], span: SourceSpan, _ctx: &Arc<RuntimeCtx>) -> Result<LxVal, LxError> {
  global_context_get(&args[0], span)
}

pub(super) fn bi_resolve_handler(args: &[LxVal], _span: SourceSpan, _ctx: &Arc<RuntimeCtx>) -> Result<LxVal, LxError> {
  let agent = &args[0];
...
pub(super) fn bi_try(args: &[LxVal], span: SourceSpan, ctx: &Arc<RuntimeCtx>) -> Result<LxVal, LxError> {
  let f = &args[0];
...
pub(super) fn bi_methods_of(args: &[LxVal], _span: SourceSpan, _ctx: &Arc<RuntimeCtx>) -> Result<LxVal, LxError> {

...
pub(super) fn bi_take_while(args: &[Value], sp: Span) -> Result<Value, LxError> {
...
pub(super) fn bi_drop_while(args: &[Value], sp: Span) -> Result<Value, LxError> {
...
pub(super) fn bi_sort_by(args: &[Value], sp: Span) -> Result<Value, LxError> {
...
pub(super) fn bi_min_by(args: &[Value], sp: Span) -> Result<Value, LxError> {
...
pub(super) fn bi_max_by(args: &[Value], sp: Span) -> Result<Value, LxError> {
...
pub(super) fn bi_partition(args: &[Value], sp: Span) -> Result<Value, LxError> {
...
pub(super) fn bi_group_by(args: &[Value], sp: Span) -> Result<Value, LxError> {
...
pub(super) fn bi_chunks(args: &[Value], sp: Span) -> Result<Value, LxError> {
...
pub(super) fn bi_windows(args: &[Value], sp: Span) -> Result<Value, LxError> {
...
pub(super) fn bi_intersperse(args: &[Value], sp: Span) -> Result<Value, LxError> {
...
pub(super) fn bi_scan(args: &[Value], sp: Span) -> Result<Value, LxError> {
...
pub(super) fn bi_tap(args: &[Value], sp: Span) -> Result<Value, LxError> {
  let val = &args[1];
  call(&args[0], val.clone(), sp)?;
  Ok(val.clone())
}

pub(super) fn bi_pmap(args: &[Value], sp: Span) -> Result<Value, LxError> {
...
pub(super) fn bi_pmap_n(args: &[Value], sp: Span) -> Result<Value, LxError> {
...
pub(super) fn bi_find_index(args: &[Value], sp: Span) -> Result<Value, LxError> {

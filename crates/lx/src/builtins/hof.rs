...
pub(super) fn register(env: &mut Env) {
    ...
    env.bind(
        "take_while".into(),
        mk("take_while", 2, super::hof_extra::bi_take_while),
    );
    env.bind(
        "drop_while".into(),
        mk("drop_while", 2, super::hof_extra::bi_drop_while),
    );
    env.bind(
        "sort_by".into(),
        mk("sort_by", 2, super::hof_extra::bi_sort_by),
    );
    env.bind(
        "min_by".into(),
        mk("min_by", 2, super::hof_extra::bi_min_by),
    );
    env.bind(
        "max_by".into(),
        mk("max_by", 2, super::hof_extra::bi_max_by),
    );
    env.bind(
        "partition".into(),
        mk("partition", 2, super::hof_extra::bi_partition),
    );
    env.bind(
        "group_by".into(),
        mk("group_by", 2, super::hof_extra::bi_group_by),
    );
    env.bind(
        "chunks".into(),
    ...
    env.bind(
        "find_index".into(),
        mk("find_index", 2, super::hof_extra::bi_find_index),
    );
    env.bind("pmap".into(), mk("pmap", 2, super::hof_extra::bi_pmap));
    env.bind(
        "pmap_n".into(),
        mk("pmap_n", 3, super::hof_extra::bi_pmap_n),
    );
}
...
fn bi_map(args: &[Value], sp: Span, ctx: &Arc<RuntimeCtx>) -> Result<Value, LxError> {
...
fn bi_filter(args: &[Value], sp: Span, ctx: &Arc<RuntimeCtx>) -> Result<Value, LxError> {
...
fn bi_fold(args: &[Value], sp: Span, ctx: &Arc<RuntimeCtx>) -> Result<Value, LxError> {
...
fn bi_flat_map(args: &[Value], sp: Span, ctx: &Arc<RuntimeCtx>) -> Result<Value, LxError> {
...
fn bi_each(args: &[Value], sp: Span, ctx: &Arc<RuntimeCtx>) -> Result<Value, LxError> {
...
fn bi_find(args: &[Value], sp: Span, ctx: &Arc<RuntimeCtx>) -> Result<Value, LxError> {
...
fn bi_any(args: &[Value], sp: Span, ctx: &Arc<RuntimeCtx>) -> Result<Value, LxError> {
...
fn bi_all(args: &[Value], sp: Span, ctx: &Arc<RuntimeCtx>) -> Result<Value, LxError> {
...
fn bi_none_q(args: &[Value], sp: Span, ctx: &Arc<RuntimeCtx>) -> Result<Value, LxError> {
...
fn bi_count(args: &[Value], sp: Span, ctx: &Arc<RuntimeCtx>) -> Result<Value, LxError> {

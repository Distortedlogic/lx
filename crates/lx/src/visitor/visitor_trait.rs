...
pub trait AstVisitor {
  ...
  fn visit_stmt(&mut self, _id: StmtId, _stmt: &Stmt, _span: SourceSpan, _arena: &AstArena) -> VisitAction {
    VisitAction::Descend
  }
  ...
  fn leave_binding(&mut self, _id: StmtId, _binding: &Binding, _span: SourceSpan, _arena: &AstArena) -> ControlFlow<()> {
    ControlFlow::Continue(())
  }
  fn visit_type_def(&mut self, _id: StmtId, _def: &StmtTypeDef, _span: SourceSpan, _arena: &AstArena) -> VisitAction {
    VisitAction::Descend
  }
  fn visit_trait_decl(&mut self, _id: StmtId, _data: &TraitDeclData, _span: SourceSpan, _arena: &AstArena) -> VisitAction {
    VisitAction::Descend
  }
  fn leave_trait_decl(&mut self, _id: StmtId, _data: &TraitDeclData, _span: SourceSpan, _arena: &AstArena) -> ControlFlow<()> {
    ControlFlow::Continue(())
  }
  fn visit_class_decl(&mut self, _id: StmtId, _data: &ClassDeclData, _span: SourceSpan, _arena: &AstArena) -> VisitAction {
    VisitAction::Descend
  }
  fn leave_class_decl(&mut self, _id: StmtId, _data: &ClassDeclData, _span: SourceSpan, _arena: &AstArena) -> ControlFlow<()> {
    ControlFlow::Continue(())
  }
  fn visit_trait_union(&mut self, _id: StmtId, _def: &TraitUnionDef, _span: SourceSpan, _arena: &AstArena) -> VisitAction {
    VisitAction::Descend
  }
  fn visit_field_update(&mut self, _id: StmtId, _update: &StmtFieldUpdate, _span: SourceSpan, _arena: &AstArena) -> VisitAction {
    VisitAction::Descend
  }
  fn leave_field_update(&mut self, _id: StmtId, _update: &StmtFieldUpdate, _span: SourceSpan, _arena: &AstArena) -> ControlFlow<()> {
    ControlFlow::Continue(())
  }
  fn visit_use(&mut self, _id: StmtId, _stmt: &UseStmt, _span: SourceSpan, _arena: &AstArena) -> VisitAction {
    VisitAction::Descend
  }
  fn visit_expr(&mut self, _id: ExprId, _expr: &Expr, _span: SourceSpan, _arena: &AstArena) -> VisitAction {
    VisitAction::Descend
  }

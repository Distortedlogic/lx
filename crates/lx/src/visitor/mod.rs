use crate::ast::{
  ...
  SType, Section, SelArm, ShellMode, Stmt, StrPart, TraitDeclData, TraitUnionDef, TypeExpr, TypeField, UnaryOp, UseStmt,
};
use crate::span::Span;
...
pub trait AstVisitor {
  ...
  fn visit_type_def(&mut self, _name: &str, _variants: &[(String, usize)], _exported: bool, _span: Span) {}
  fn visit_trait_decl(&mut self, _data: &TraitDeclData, _span: Span) {}
  fn visit_class_decl(&mut self, data: &ClassDeclData, span: Span) {
    walk_class_decl(self, data, span);
  }
  fn visit_class_decl_post(&mut self, _data: &ClassDeclData, _span: Span) {}
  fn visit_trait_union(&mut self, _def: &TraitUnionDef, _span: Span) {}
  ...
  fn visit_block_post(&mut self, _stmts: &[crate::ast::SStmt], _span: Span) {}
  ...
  fn visit_slice(&mut self, expr: &SExpr, start: Option<&SExpr>, end: Option<&SExpr>, span: Span) {
  ...
  fn visit_loop_post(&mut self, _stmts: &[crate::ast::SStmt], _span: Span) {}
  ...
  fn visit_par_post(&mut self, _stmts: &[crate::ast::SStmt], _span: Span) {}
  ...
  fn visit_with(&mut self, _name: &str, value: &SExpr, body: &[crate::ast::SStmt], _mutable: bool, span: Span) {
    walk_with(self, value, body, span);
  }
  fn visit_with_post(&mut self, _name: &str, _value: &SExpr, _body: &[crate::ast::SStmt], _mutable: bool, _span: Span) {}
  fn visit_with_resource(&mut self, resources: &[(SExpr, String)], body: &[crate::ast::SStmt], span: Span) {
    walk_with_resource(self, resources, body, span);
  }
  fn visit_with_resource_post(&mut self, _resources: &[(SExpr, String)], _body: &[crate::ast::SStmt], _span: Span) {}
  fn visit_with_context(&mut self, fields: &[(String, SExpr)], body: &[crate::ast::SStmt], span: Span) {
    walk_with_context(self, fields, body, span);
  }
  fn visit_with_context_post(&mut self, _fields: &[(String, SExpr)], _body: &[crate::ast::SStmt], _span: Span) {}

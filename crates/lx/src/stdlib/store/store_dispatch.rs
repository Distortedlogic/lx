...
pub fn object_update_nested(id: u64, path: &[String], value: crate::value::LxVal) -> Result<(), String> {
...
fn update_nested_record(val: &crate::value::LxVal, path: &[String], new_val: crate::value::LxVal) -> Result<crate::value::LxVal, String> {

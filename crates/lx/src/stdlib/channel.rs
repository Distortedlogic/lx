...
pub fn build() -> IndexMap<crate::sym::Sym, LxVal> {
  ...
  m.insert(crate::sym::intern("create"), crate::builtins::mk("channel.create", 1, bi_create));
  m.insert(crate::sym::intern("send"), crate::builtins::mk_async("channel.send", 2, bi_send));
  m.insert(crate::sym::intern("recv"), crate::builtins::mk_async("channel.recv", 1, bi_recv));
  m.insert(crate::sym::intern("try_recv"), crate::builtins::mk("channel.try_recv", 1, bi_try_recv));
  m.insert(crate::sym::intern("close"), crate::builtins::mk("channel.close", 1, bi_close));
  m
}

...
fn make_default_pane(kind: PaneKind, id: String) -> PaneNode {
    match kind {
        PaneKind::Terminal => PaneNode::Terminal {
            id,
            working_dir: ".".into(),
            command: None,
        },
        PaneKind::Browser => PaneNode::Browser {
            id,
            url: "about:blank".into(),
            devtools: false,
        },
        PaneKind::Editor => PaneNode::Editor {
            id,
            file_path: String::new(),
            language: None,
        },
        PaneKind::Agent => PaneNode::Agent {
            id: id.clone(),
            session_id: Uuid::new_v4().to_string(),
            model: "claude-sonnet-4-6".into(),
        },
        PaneKind::Canvas => PaneNode::Canvas {
            id,
            widget_type: "markdown".into(),
            config: serde_json::Value::Object(Default::default()),
        },
        PaneKind::Chart => PaneNode::Chart {
            id,
            chart_json: String::new(),
            title: None,
        },
        PaneKind::FlowGraph => PaneNode::FlowGraph {
            id,

...
(function (LxCharts) {
    function initFlowGraph(id, graphJson) {
        ...
        if (!graphJson.tooltip)
            graphJson.tooltip = {};
        if (!graphJson.tooltip.backgroundColor)
            graphJson.tooltip.backgroundColor = tbg;
        if (!graphJson.tooltip.borderColor)
            graphJson.tooltip.borderColor = bc;
        if (!graphJson.tooltip.textStyle)
            graphJson.tooltip.textStyle = {};
        if (!graphJson.tooltip.textStyle.color)
            graphJson.tooltip.textStyle.color = fg;
        if (!graphJson.textStyle)
            graphJson.textStyle = {};
    ...
    LxCharts.initFlowGraph = initFlowGraph;
    ...
    LxCharts.updateFlowGraphStatus = updateFlowGraphStatus;
})(LxCharts || (LxCharts = {}));

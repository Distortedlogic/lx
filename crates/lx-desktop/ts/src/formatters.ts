namespace LxCharts {
  ...
  export function alpsTooltipFormatter(params: any, popData: number[], fitnessData: string[]): string {
  ...
  export function scatterTooltipFormatter(params: any, xLabel: string, yLabel: string): string {
  ...
  export function memoryTooltip(params: any): string {
    ...
    var sorted = params.slice().filter(function(p: any) { return p.value != null && p.value !== 0; });
    sorted.sort(function(a: any, b: any) { return Math.abs(b.value) - Math.abs(a.value); });

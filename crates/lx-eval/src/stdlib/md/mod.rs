...
fn bi_h1(args: &[LxVal], span: SourceSpan, _: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
  Ok(node_rec("heading", vec![("level", LxVal::int(1)), ("text", LxVal::str(args[0].require_str("md.h1", span)?))]))
}
fn bi_h2(args: &[LxVal], span: SourceSpan, _: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
  Ok(node_rec("heading", vec![("level", LxVal::int(2)), ("text", LxVal::str(args[0].require_str("md.h2", span)?))]))
}
fn bi_h3(args: &[LxVal], span: SourceSpan, _: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
  Ok(node_rec("heading", vec![("level", LxVal::int(3)), ("text", LxVal::str(args[0].require_str("md.h3", span)?))]))
}
fn bi_para(args: &[LxVal], span: SourceSpan, _: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
  Ok(node_rec("para", vec![("text", LxVal::str(args[0].require_str("md.para", span)?))]))
}
fn bi_code(args: &[LxVal], span: SourceSpan, _: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
...
fn bi_list(args: &[LxVal], span: SourceSpan, _: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
...
fn bi_ordered(args: &[LxVal], span: SourceSpan, _: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
...
fn bi_table(args: &[LxVal], span: SourceSpan, _: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
...
fn bi_link(args: &[LxVal], span: SourceSpan, _: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
...
fn bi_blockquote(args: &[LxVal], span: SourceSpan, _: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
  Ok(node_rec("blockquote", vec![("text", LxVal::str(args[0].require_str("md.blockquote", span)?))]))
}
fn bi_hr(_: &[LxVal], _: SourceSpan, _: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
  Ok(node_rec("hr", vec![]))
}
fn bi_raw(args: &[LxVal], span: SourceSpan, _: &dyn BuiltinCtx) -> Result<LxVal, LxError> {

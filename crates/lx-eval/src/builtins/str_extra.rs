...
pub(super) fn bi_replace(args: &[LxVal], span: SourceSpan, _ctx: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
...
pub(super) fn bi_replace_all(args: &[LxVal], span: SourceSpan, _ctx: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
...
pub(super) fn bi_repeat(args: &[LxVal], span: SourceSpan, _ctx: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
...
pub(super) fn bi_starts(args: &[LxVal], span: SourceSpan, _ctx: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
  let prefix = args[0].require_str("starts?", span)?;
  let s = args[1].require_str("starts?", span)?;
  Ok(LxVal::Bool(s.starts_with(prefix)))
}

pub(super) fn bi_ends(args: &[LxVal], span: SourceSpan, _ctx: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
...
pub(super) fn bi_pad_left(args: &[LxVal], span: SourceSpan, _ctx: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
  pad(args, span, "pad_left", true)
}

pub(super) fn bi_pad_right(args: &[LxVal], span: SourceSpan, _ctx: &dyn BuiltinCtx) -> Result<LxVal, LxError> {

...
fn bi_collect(args: &[LxVal], _span: SourceSpan, _ctx: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
  match &args[0] {
...
fn bi_step(args: &[LxVal], span: SourceSpan, _ctx: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
...
fn bi_require(args: &[LxVal], _span: SourceSpan, _ctx: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
  match &args[1] {
...
fn bi_parse_int(args: &[LxVal], span: SourceSpan, _ctx: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
  match &args[0] {
...
fn bi_parse_float(args: &[LxVal], span: SourceSpan, _ctx: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
  match &args[0] {
...
fn bi_to_int(args: &[LxVal], span: SourceSpan, _ctx: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
  match &args[0] {
...
fn bi_to_float(args: &[LxVal], span: SourceSpan, _ctx: &dyn BuiltinCtx) -> Result<LxVal, LxError> {
  match &args[0] {

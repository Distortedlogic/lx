...
- [workflow-dsls/agent_dsl_landscape_2026.md](workflow-dsls/agent_dsl_landscape_2026.md) — 35+ agent DSLs/specs beyond the 12 frameworks: MeTTa, APPL, POML, EnCompass, Oracle Agent Spec, PayPal production DSL, Rust-native ecosystem (Rig, rs-graph-llm), prompt markup languages, six-approach taxonomy

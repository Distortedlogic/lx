...
pub fn add_terminal_tab(state: Signal<TabsState>, id: String, title: String, working_dir: String, command: Option<String>) {
  add_tab(state, id.clone(), title, PaneNode::Terminal { id, working_dir, command });
}
